...
os.chdir("~/nonIBD_colonoscopyReport/linked")

notes_file = 'colo_path_linked.csv' # Created in step 16

# Define headers for CSVs
notes_headers = ["PathologyReportID", "InputText"]
...
# Write outputs
with open("PathologyReportIDs.txt", "w", encoding="utf-8") as f:
    f.writelines(f"{sid}\n" for sid in sids)
