...
* Calibration curves (`step6_calibration_plots...R`): Generates calibration curves for all 16 binary risk profiles (e.g., `0000` vs `0001` vs. `0010` vs. ...) as shown in **Supp. Fig 1B**.
