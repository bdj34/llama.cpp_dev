...
This repository contains the pipeline designed to process Pathology and Colonoscopy reports using SQL/R/python-based filtering and Large Language Models (LLMs). 
...
### 2. Pathology Classification (dysplasiaClassifier)
...
### 3. Colonoscopy Report Identification/Filtering
...
### 4. Colonoscopy Report Validation (yes/no) and Whitelisting
...
### 5. Unlinked Colonoscopy Extraction
...
### 7. Linked Colonoscopy/Pathology Extraction
